...
{
    public partial class visualStorage2 : Form
    {
        private Area findPlace;
        private Order takenOrder;
        private bool isItDocument;
        public visualStorage2(Area a, Order o, bool b)
        {
            InitializeComponent();
        ...
        {
            Storage b = Program.Storages.ElementAt(1);
            float freeSpace = b.calculateFreeSpace();
            float byPrecent = b.freeSpaceByPrecent(freeSpace);
