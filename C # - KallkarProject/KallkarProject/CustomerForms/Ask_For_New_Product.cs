...
namespace KallkarProject
{
    public partial class Ask_For_New_Product : Form
    {
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("the product is sent to the factory's approval, we will let you know more details as soon as we can");
            this.Hide();
            makeNewOrder ec = new makeNewOrder(cus,null);
            ec.Show();
        }
        ...
        {
            makeNewOrder mno = new makeNewOrder(cus, null);
            mno.Show();
            this.Hide();
