...
namespace KallkarProject
{
    public class Order
    {
        ...
        public Order(DateTime curentDate, DateTime targetDate1, Customer customer)
        {  //order provide by customer
            serialNum += 1;
        ...
        public void setrouteOrderNum(int routeOrderNum1)
        {
            Update_OrderRoute(this.orderId, routeOrderNum1);
            this.routeOrderNum = routeOrderNum1;
        }

        public void Update_OrderRoute(string orderId1, int Route)
        {
            SqlCommand c = new SqlCommand();
            c.CommandText = "EXECUTE dbo.SP_Update_OrderRoute @OrderID , @RouteOrderNum";
            c.Parameters.AddWithValue("@OrderID", orderId1);
            c.Parameters.AddWithValue("@RouteOrderNum", Route);
            SQL_CON SC = new SQL_CON();
            SC.execute_non_query(c);
        }
        ...
        public void Update_OrderWeightPrice()
        {
            SqlCommand c = new SqlCommand();
            c.CommandText = "EXECUTE dbo.SP_Update_OrderWeightPriceCapacity @OrderID , @Price, @Weight, @Capacity";
            c.Parameters.AddWithValue("@OrderID", this.orderId);
            c.Parameters.AddWithValue("@Price", this.Price);
            c.Parameters.AddWithValue("@Weight", this.weight);
            c.Parameters.AddWithValue("@Capacity", this.capacity);
        ...
        public void setcapacity(float tempCap)
        {
        ...
        public void setWight(float tempWight)
        {
            this.weight += tempWight;
        }
        ...
        public void setOrderShipment(Shipment tempShipment)
        {

            this.shipment = tempShipment;
        }
    }
